...
Mounting the Docker socket into a container exposes the Docker daemon, granting root-equivalent host control to any process inside.

**Typical Impact**

Full host compromise, unauthorized access to secrets and credentials, and lateral movement across infrastructure.
