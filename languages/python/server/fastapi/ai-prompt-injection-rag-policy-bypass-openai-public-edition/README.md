...
Unsafe concatenation of system instructions, internal context, and untrusted user input enables attackers to override model behavior.

**Typical Impact**

Disclosure of internal data, operational workflows, secrets, and bypass of AI policy controls.
