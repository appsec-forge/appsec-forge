...
Backend performs requests to attacker-controlled URLs.

**Typical Impact**

Internal resources become reachable through the application, enabling access to internal services and sensitive data.
